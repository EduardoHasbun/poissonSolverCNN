...
if __name__ == '__main__':
    ...
    def generate_random_charge(xmin, xmax, ymin, ymax, zmin, zmax):
        random_position = [np.random.uniform((xmax - xmin)*0.3, (xmax - xmin)*0.7),
                           np.random.uniform((ymax - ymin)*0.3, (ymax - ymin)*0.7),
                           np.random.uniform((zmax - zmin)*0.3, (zmax - zmin)*0.7)]
