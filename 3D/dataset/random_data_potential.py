...
if __name__ == '__main__':
    ...
    for idx, random_data in log_progress(enumerate(generate_random(nits)), total=nits, desc="Processing"):
        ...
        laplacian_matrix = diags([diag, diag, diag, diag, diag, diag, diag, diag, diag], offsets, shape=(nnx * nny * nnz, nnx * nny * nnz)).tocsr()
        ...
        potential = potential_reshape.reshape((nnx, nny, nnz))
