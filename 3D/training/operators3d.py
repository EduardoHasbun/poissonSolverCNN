...
class InterfaceBoundaryLoss(nn.Module):
    ...
    def forward(self, subdomain1, subdomain2, constant_value = 1.0):
        ...
        grad_x_sub1_interface, grad_y_sub1_interface, grad_z_sub1_interface = grad_x_sub1[:, 0, self.boundary], grad_y_sub1[:, 0, self.boundary], grad_z_sub1[:, 0, self.boundary]
        grad_x_sub2_interface, grad_y_sub2_interface, grad_z_sub2_interface = grad_x_sub2[:, 0, self.boundary], grad_y_sub2[:, 0, self.boundary], grad_z_sub2[:, 0, self.boundary]
