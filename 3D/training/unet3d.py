...
class UNet3D(nn.Module):
    def __init__(self, scales, kernel,input_res):
        ...
        self.ConvsUp = nn.ModuleList([
            _ConvBlock3D(scales[1][1], kernel, upsample_size=(int(input_res/4), int(input_res/4), int(input_res/24))),
            _ConvBlock3D(scales[2][1], kernel, upsample_size=(int(input_res/2), int(input_res/2), int(input_res/2))),
            _ConvBlock3D(scales[3][1], kernel, upsample_size=(int(input_res), int(input_res), int(input_res))),
